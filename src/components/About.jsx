...
const About = () => {
  ...
  return (
    <div name='about' className="w-screen h-screen  bg-to-b from-white to-black  flex flex-col">
      
        <div className='max-w-screem-lg p-4 mx-auto flex flex-col justify-center flex-1'>
            <div className='pb-10'>
